...
function CartaoPopup(props) {
    const d = props.dados;

    const encoded = encodeURI(d.linkPDF);
    const whatslink = "https://wa.me/?text=" + encoded
    return (
        <Popup>
            <h6 style={{ textAlign: "center" }}><b>Cartão {d.cartao}</b></h6>
            <b>Cartão:</b> {d.cartaoNomeCompleto}<br />
            <b>Quantidade:</b> {d.quantidade} endereços <br />
            <b>Ultima vez:</b> {props.ultimavez} <br />
            <b>Ócio:</b> {props.ocio} dias <br />
            <b>Região:</b> {d.regiao}<br />
            <b>Localidade:</b> {d.localidade}<br />
